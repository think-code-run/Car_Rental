...
const Footer = () => {
    return (
        <div className='px-6 md:px-24 xl:px-32 mt-60 text-sm text-gray-500'>
            <div className='flex flex-wrap justify-between items-start gap-8 pb-6 border-borderColor border-b '>
                <div>
                    <img src={assets.logo} alt="logo" className='h-8 md:h-9' />
                    <p className='max-w-80 mt-3'>
                        Premium car rental service with a wide selection of luxury and everyday vehicles. Enjoy seamless booking, top-notch customer service, and competitive pricing for your next adventure.
                    </p>
                ...
                <div>
                    ...
                    <ul className='mt-3 flex flex-col gap-1.5'>
                        <li>Sastra Thanjavur</li>
                        <li>TamilNadu , India</li>
                        <li>+91 9999999999</li>
                        <li>126994929@sasta.ac.in</li>
                    </ul>
                </div>
